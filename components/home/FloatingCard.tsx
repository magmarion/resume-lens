...
export function FloatingCard() {
    return (
        <div className="w-full max-w-100 rounded-2xl border border-white/9 bg-linear-to-br from-white/6 to-white/2 backdrop-blur-2xl shadow-[0_0_0_1px_rgba(0,0,0,0.4),0_32px_80px_rgba(0,0,0,0.65),0_0_60px_rgba(45,125,110,0.1)] overflow-hidden">
            ...
            <div className="px-4.5 py-3.5 pb-4.5">
                ...
                <div className="mt-3 p-[10px_12px] rounded-[10px] bg-emerald-600/10 border border-emerald-600/22">
                    <div className="text-[10px] font-semibold text-emerald-400 tracking-[0.06em] uppercase mb-1">
                        AI Suggestion
                    </div>
